<template>
    <div class="join-team">
        ...
        <h1> Join a team </h1>
        <p> Your account hasn't been added to a Sunfile team yet. If you've been given access to Sunfile and have received a Team Code, enter it here. </p>
		<b-input :state="validation" size="lg" class="joinTeamInput" v-model="teamCode" type="text" placeholder="Team Code"></b-input>
		<b-form-invalid-feedback class="joinTeamFeedback" :state="validation">
			A team code is exactly six characters long.
		</b-form-invalid-feedback>
		<b-button :disabled="submitDisabled" class="joinTeamSubmit" type="submit" variant="primary" size="lg" v-on:click="joinTeam">
